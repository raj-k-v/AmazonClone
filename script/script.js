...
loadProducts(renderProductGrid); //this render product grid is called a callback means that it is being called in the future a settimeout is also and example of callback as we set a time and call the function after that time 
